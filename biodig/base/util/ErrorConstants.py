from WebServiceException import WebServiceException, CustomWebServiceException
'''
         ---------------------------------------------------------
...
INTERNAL_ERROR = WebServiceException("An unexpected error has occurred with your input. Please email the administrator of this BioDIG site for help.", 500)
