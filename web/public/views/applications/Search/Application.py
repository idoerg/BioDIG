...
from web.public.views.pagelets.ImageSearchPagelet import ImageSearchPagelet
from web.public.views.pagelets.GBrowseSearchPagelet import GBrowseSearchPagelet
